export default function ExperienceRoute() {
    return (
        <div className="container flex flex-col justify-center items-center">
            <div id="experience" className="w-[68%] flex flex-col p-10">
                <h1 className="text-cyan-500 text-5xl font-bold mb-4">EXPERIENCE</h1>
                ...
                <ul className="text-gray-200 mt-2 space-y-2 text-lg max-w-2xl list-disc ">
