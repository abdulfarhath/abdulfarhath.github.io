...
export default function HomeRoute() {
  return (
    <section id="home" className="section-spacing pt-32 md:pt-36">
      <div className="section-container">
        {/* Main content area */}
        <div className="flex flex-col lg:flex-row gap-10 md:gap-16 items-center justify-center">
          ...
          <div className="left text-center lg:text-left hidden lg:block">
            ...
            <div className="socials flex flex-wrap justify-center lg:justify-start gap-4 mt-5">
              <a href="https://github.com/abdulfarhath" target="_blank" rel="noopener noreferrer"
                className="bg-gray-800/80 p-3 rounded-lg hover:bg-cyan-600/20 hover:border-cyan-500/50 border border-transparent transition-all duration-300">
              ...
              <a href="#footer" className="bg-gray-800/80 p-3 rounded-lg hover:bg-cyan-600/20 hover:border-cyan-500/50 border border-transparent transition-all duration-300">
              ...
              <a
                ...
                className="flex items-center gap-2 bg-cyan-600 hover:bg-cyan-500 text-white px-4 py-2 rounded-lg font-medium transition-colors duration-300"
              >
                <FaFileAlt /> Resume
              </a>
            </div>
          ...
          <div className="right flex justify-center">
            <div className="relative">
              <img
                src={farhathImage}
                alt="Farhath's Image"
                className="rounded-xl border-4 border-cyan-500/30 shadow-lg shadow-cyan-500/20 w-48 md:w-56 lg:w-64 z-10 relative"
              />
            </div>
          </div>
        </div>
        ...
        {/* about */}
        <div className="card flex flex-col md:flex-row items-center justify-center gap-8 mt-16">
          {/* profile and links */}
            ...
            <div className='flex flex-col items-center md:items-start'>
              ...
              <div className="profiles flex gap-4">
                <a href="https://www.hackerrank.com/abdulfarhathmohd" target="_blank" rel="noopener noreferrer"
                  className="bg-gray-800/80 p-2 rounded-lg hover:bg-gray-700 transition-colors duration-300">
          ...
          <div className="about-txt md:w-2/3 mt-6 md:mt-0 text-center md:text-left">
            <h1 className="text-xl md:text-2xl text-cyan-400 mb-3 pb-2 border-b border-gray-700/50">About Me</h1>
